...
Sikshantra is a fully web-based Academic Management System (PHP + MySQL) designed for educational institutions and coaching centers. It centralizes key academic tasks like tracking attendance, submitting assignments, managing feedback, handling quizzes, organizing timetable, and generating reports.
...
Login / Authentication: index.php or /includes/login.php
Attendance Module: /teacher/attendance.php
Assignment Module: /teacher/assignment.php, /student/submission.php
Feedback Module: /student/feedback.php, /admin/feedback_summary.php
